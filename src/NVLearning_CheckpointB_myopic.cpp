...
// Copyright   : ...
// Description : general code for newsvendor with censored demand --- the (myopic) Checkpoint-B heuristic
//               compile using Intel icc: icpc -std=c++11 -openmp -O3 -fast -o NVLearning_CheckpointB_myopic.exe NVLearning_CheckpointB_myopic.cpp
//============================================================================
...
{
    //Open output file
    file.open("NVLearning_CheckpointB_myopic.txt", fstream::app|fstream::out);
    
    if (! file)
    {
        //if fail to open the file
        cerr << "can't open output file NVLearning_CheckpointB_myopic.txt!" << endl;
        exit(EXIT_FAILURE);
    }
    ...
    cout << "r\tc\talpha\tbeta\tM\tQ_Bm\tPi_Bm\tTime_Bm\tCPUTime_Bm" << endl;
    ...
    file << "r\tc\talpha\tbeta\tM\tQ_Bm\tPi_Bm\tTime_Bm\tCPUTime_Bm" << endl;
